...
export const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Visit Us',
      details: ['123 Tech Street', 'Digital City, Delhi 110001', 'India'],
    ...
    },
    {
      ...
      description: 'Get instant support through our live chat feature'
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Course duration varies from 4-12 weeks depending on the program and your pace. 
                  Most students complete courses within 6-8 weeks.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  We offer 24/7 technical support, live chat, and dedicated mentors for each course.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  We offer a 30-day money-back guarantee if you're not completely satisfied with your course.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Yes, we provide special pricing for teams and organizations. Contact us for custom quotes.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Absolutely! We have courses designed for all skill levels, from complete beginners to advanced professionals.
                </p>
              </div>
            </div>
          </div>
